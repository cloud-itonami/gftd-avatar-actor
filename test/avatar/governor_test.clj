(ns avatar.governor-test
  (:require [clojure.test :refer [deftest testing is]]
            [avatar.governor :as governor]))

(def clean-asset
  {:kind :asset :format "vrm" :license :cc0 :title "gentle-smile, matte-cloth"
...
(deftest format-mismatch-is-hard
  (is (seq (governor/violations (assoc clean-asset :format "psd")))))

(deftest glb-format-is-allowed
  (testing "glb is an accepted output format alongside vrm"
