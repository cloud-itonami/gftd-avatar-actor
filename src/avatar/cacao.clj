(ns avatar.cacao
  "Agent-side CACAO issuance (JVM) for gftd-avatar-actor. 1:1 port of the
  ...
  The private key is persisted to `.avatar/identity.edn` (gitignored) —
...
(def default-db-name
  "gftd-avatar-actor's own database."
  "avatar")
