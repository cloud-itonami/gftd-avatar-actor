(ns avatar.governor
  ...
  — not a semantic quality judge, avatar.cosci already ran that; this
  re-checks hard invariants avatar.judge/avatar.cosci have no notion of:
  license freedom, format, safety, no-actuation).
...
(defn violations
  ...
  avatar.loop before this check) -> violation strings. Empty = passes."
  [asset]
  (cond-> []
